...
const CityQuestion = ({ question, presentQuestion, setUseCityComponent, useCityComponent }) => {
        ...
        <div className='cities'>
          <ul>
            <li className="li_cities li_cities_barranquilla">
              ...
              <button onClick={addCity} category={question[presentQuestion].response.cities[1].name} />
            ...
            <li className="li_cities li_cities_bogota">
              ...
              <button onClick={addCity} category={question[presentQuestion].response.cities[3].name}/>
              <div className='circle' />
            </li>
            <li className="li_cities li_cities_cali">
              ...
              <button onClick={addCity} category={question[presentQuestion].response.cities[2].name}/>
              <div className='circle' />
            </li>
            <li className="li_cities li_cities_medellin">
              ...
              <button onClick={addCity} category={question[presentQuestion].response.cities[0].name}/>
              <div className='circle' />
            </li>
          </ul>
        </div>
